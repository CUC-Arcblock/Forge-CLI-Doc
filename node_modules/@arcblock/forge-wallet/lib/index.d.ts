...
declare namespace _Lib {
  ...
  export interface WalletObject {
    // 导出一个钱包对象
    type: WalletTypeObject; // 钱包对象的类型
    secretKey: any;         // 私钥
    publicKey: any;         // 公钥
    sign: (...args: any[]) => any;      // 签名
    verify: (...args: any[]) => any;    // 验证
    toAddress: (...args: any[]) => any; // 转成地址
    toJSON: (...args: any[]) => any;    // 序列化
  }
